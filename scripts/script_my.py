...
files = [
     './results/rui/testC_my_1Vu_5Wh.json',
     './results/rui/testC_my_2Vu_10Wh.json',
     './results/rui/testC_my_4Vu_20Wh.json',
     './results/rui/testC_my_8Vu_40Wh.json',
     './results/rui/testC_my_10Vu_50Wh.json'
 ]
