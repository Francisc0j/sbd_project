...
def generate_comparison_plot(times1, tpm1, times2, tpm2):
    ...
    plt.plot(times1_filtered, tpm1_filtered, label='testA_my_1Vu_5Wh', color='orange', marker='o', linestyle='-', markersize=6)
    plt.plot(times2_filtered, tpm2_filtered, label='testA_my_10Vu_50Wh', color='blue', marker='o', linestyle='-', markersize=6)  # Usando círculos
...
file1 = './results/francisco/testA_my_1Vu_5Wh.json'  # Substitua pelo caminho do seu primeiro arquivo JSON
file2 = './results/francisco/testA_my_10Vu_50Wh.json'  # Substitua pelo caminho do seu segundo arquivo JSON
